      ...
      <div className="w-full max-w-xs">
        ...
        <div className="box p-4">
          <div className="space-y-3">
            <p className="text-sm text-fg-subtle text-center mb-1">Sign in to continue</p>
            <button type="button" onClick={() => loginWithGoogle()} className="btn-secondary w-full flex items-center justify-center gap-2">
            ...
            <button type="button" onClick={() => loginWithGithub()} className="btn-secondary w-full flex items-center justify-center gap-2">
